package co.nimblehq.githubactionsrunner.domain.usecase.base

import co.nimblehq.githubactionsrunner.data.service.error.NoConnectivityException
import co.nimblehq.githubactionsrunner.domain.BuildConfig
import co.nimblehq.githubactionsrunner.domain.data.error.AppError
import co.nimblehq.githubactionsrunner.domain.data.error.NoConnectivityError
